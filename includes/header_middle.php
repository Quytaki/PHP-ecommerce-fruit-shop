            ...
            <div class="col-lg-6 col-md-7 hidden-sm hidden-xs">
                <div class="primary-menu">
                    <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu">
                        ...
                        <li class="menu-item"><a href="all_product.php">Danh Sách Sản Phẩm</a></li>
                        <li class="menu-item"><a href="about_us.php">Về Chúng Tôi</a></li>
                        <li class="menu-item"><a href="privacy_policy.php">Chính Sách</a></li>
                        <li class="menu-item"><a href="<?php echo isset($_SESSION['user_id']) ? 'exist_order.php' : 'user_login.php'; ?>">Giỏ Hàng</a></li>
                    </ul>
                </div>
            </div>
