<div class="advance-product-box">
                                <div class="biolife-title-box bold-style biolife-title-box__bold-style">
                                    <h3 class="title">Khuyến mãi trong ngày</h3>
                                </div>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product deal-layout contain-product__deal-layout">
                                            ...
                                            <div class="info">
                                                ...
                                                <h4 class="product-title"><a href="#" class="pr-name">Trái cây tươi thiên nhiên</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">VNĐ </span>85.000</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">VNĐ </span>95.000</span></del>
                                                </div>
