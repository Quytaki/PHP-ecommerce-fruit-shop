                        ...
                        <form action="" method="post" class="md-float-material">
                            ...
                            <div class="auth-box">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-left txt-primary">Cập nhật mật khẩu</h3>
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control" placeholder="Mật khẩu mới" name="admin_update_password" required>
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <input type="submit" name="u_admin_btn" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20" value="Cập nhật mật khẩu">
                                    </div>
                                </div>
