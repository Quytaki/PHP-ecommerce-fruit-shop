         ...
         <table class="table table-bordered" name="item-table">
             <thead>
                 <tr>
                     ...
                     <th>Số lượng</th>
                     <th>Tổng (VNĐ)</th>
                     <th> <button type="button" name="add" class="btn btn-success btn-sm add"> Thêm </button> </th>
 ...
 <script>
     $(document).ready(function() {
         ...
         $(document).on("click", ".add", function() {
             ...
             var html = "";
             html += "<tr>";
             html += '<td><select name="catagory[]" id="catagory" class="form-control item_category" data-catagory-id=' + count + '><option value="">Chọn danh mục</option><?php echo $catagory ?></select></td>';

             html += '<td><select name="product_name[]" class="form-control product_name" id="product_name' + count + '" data-product-id=' + count + '><option value="">Chọn sản phẩm</option> </select></td>';
             ...
             html += '<td><button type="button" name="remove" class="btn btn-danger remove">Xóa</button></td>';
         ...
         $(document).on('change', '.item_category', function() {
             ...
             $.ajax({
                 ...
                 success: function(data) {
                     var html = '<option value="">Tên sản phẩm</option>';
                     html += data;
