                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="customer_feedback.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert" style="font-weight: 400;" >Phản hồi của khách hàng</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" ">
                                            <a href="add_logo.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs" style="font-weight: 400;">Thêm Logo</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="manage_slider.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert" style="font-weight: 400;">Quản lý Slider</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                ...
                                <a href="../index.php" target="_blank">
                                        ...
                                        <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Xem trang web</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
